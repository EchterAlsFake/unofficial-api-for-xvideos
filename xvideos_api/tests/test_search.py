...
@pytest.mark.asyncio
async def test_sort_search(sort_option, client):
...
@pytest.mark.asyncio
async def test_sort_video_time_search(time_option, client):
...
@pytest.mark.asyncio
async def test_sort_quality_search(quality_option, client):
